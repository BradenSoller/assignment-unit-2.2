...
//FIX - only colorOne is set to 'purple' after figuring out mix is equal to true, and it wants colorTwo set to 'purple' as well, so you add colorTwo = 'purple'; directly under colorOne = 'purple';
if (mix === true) {
  colorOne = 'purple';
}
*/
